...
#define Ki 0.0f
int32_t mediaX = 0, mediaY=0, mediaZ=0;
...
#ifdef BluethootComm
			BluethootSerial.print(magCount[0], 10);
			BluethootSerial.print(",");
			BluethootSerial.print(magCount[1], 10);
			BluethootSerial.print(",");
			BluethootSerial.println(magCount[2], 10);
#else
			Serial.print(magCount[0], 10);
			Serial.print(",");
			Serial.print(magCount[1], 10);
			Serial.print(",");
			Serial.println(magCount[2], 10);
#endif
		}
